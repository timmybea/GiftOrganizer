...
class OverlayGiftViewController: UIViewController {
    ...
    lazy var tableView: UITableView = {
        ...
        tv.register(AddGiftViewCell.self, forCellReuseIdentifier: "overlayGiftCell")
        tv.bounces = false
        return tv
    }()
...
extension OverlayGiftViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "overlayGiftCell") as! AddGiftViewCell
